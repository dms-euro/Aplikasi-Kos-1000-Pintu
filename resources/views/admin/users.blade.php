            ...
            <div class="flex-none w-full max-w-full px-3">
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <h6 class="dark:text-white">Tambah Data Pengguna</h6>
                        <p class="text-sm leading-normal dark:text-white dark:opacity-80 text-slate-400">
                    ...
                    <div class="flex-auto p-6">
                        <form method="POST" action="{{ route('account.store') }}" class="space-y-4">
                            ...
                            <div class="mb-4">
                                <label for="nama"
                                    class="block mb-2 text-xs font-bold tracking-wide uppercase text-slate-400">
                                    Nama Lengkap <span class="text-red-500">*</span>
                                </label>
                                <input type="text" id="nama" name="nama"
                                    class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border border-gray-300 rounded shadow appearance-none focus:outline-none focus:shadow-outline focus:border-blue-500"
                            ...
                            <!-- Field Konfirmasi Password (opsional, untuk keamanan) -->
                            <div class="mb-4">
                            ...
                            <div class="mb-6">
                                ...
                                <select id="role" name="role"
                                    ...
                                    <option value="penghuni" {{ old('role') == 'penghuni' ? 'selected' : '' }}>Penghuni
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="flex items-center justify-end gap-4 pt-3 mt-6 border-t border-gray-200">
                                <button type="reset"
                                    class="px-4 py-2 text-xs font-bold text-white uppercase bg-gradient-to-tl from-gray-600 to-gray-400 rounded hover:shadow-lg">
                                    Batal
                                </button>
                                <button type="submit"
                                    class="px-4 py-2 text-xs font-bold text-white uppercase bg-gradient-to-tl from-blue-600 to-blue-400 rounded hover:shadow-lg">
                                    Simpan Data
                                </button>
                            </div>
                        </form>
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <div class="flex px-2 py-1">
                                                ...
                                                <div class="flex flex-col justify-center">
                                                    <h6 class="mb-0 text-sm leading-normal dark:text-white">Laurent Perrier
                                                    </h6>
                                                    <p
                                                        class="mb-0 text-xs leading-tight dark:text-white dark:opacity-80 text-slate-400">
