                    ...
                    <div class="flex flex-col md:flex-row gap-6">
                        ...
                        <div class="md:w-1/3">
                            <img src="{{ $kamar->foto_kamar ? asset('storage/' . $kamar->foto_kamar) : 'https://placehold.co/400x300/4f46e5/white?text=Kamar' }}"
                                alt="{{ $kamar->kode_kamar }}" class="w-full h-48 object-cover rounded-xl shadow-md">
                        </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-bold text-indigo-600">Rp
                                        {{ number_format($kamar->tipe_kamar->harga, 0, ',', '.') }}</p>
                                </div>
                                <div>
                    ...
                    <form action="{{ route('pemesanan.store') }}" method="POST" id="formPemesanan">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="durasi_bulanan" id="durasi_bulanan"
                                    class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                    required>
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_keluar" id="tanggal_keluar"
                                    class="w-full border border-gray-300 rounded-xl px-4 py-3 bg-gray-100" readonly>
                            </div>
                        ...
                        <button type="reset"
                            class="w-full mt-6 bg-gray-500 hover:bg-gray-600 text-white py-4 rounded-xl font-semibold shadow-lg transition transform hover:scale-[1.02]">
