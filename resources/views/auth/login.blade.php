...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        <div
            class="absolute -top-40 -right-40 w-80 h-80 bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse-slow">
        </div>
        <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-indigo-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse-slow"
            style="animation-delay: 1s;"></div>
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-pink-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse-slow"
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div
                class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-white shadow-xl mb-4 transform hover:scale-105 transition-transform duration-300">
        ...
        <div class="glass-effect rounded-2xl shadow-2xl p-8">
            <form action="{{ route('login.post') }}" method="POST" id="loginForm" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword('password')"
                            ...
                            <i class='bx bx-hide text-gray-400 hover:text-indigo-600 transition-colors duration-200'
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="#"
                        class="text-sm text-indigo-600 hover:text-indigo-700 hover:underline transition-colors duration-200">
                        Lupa password?
                    </a>
                </div>
